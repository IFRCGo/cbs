...
namespace Events.HealthRisk {
    public class HealthRiskCreated : IEvent {
        public HealthRiskCreated (Guid id, string name, int readableId, string caseDefinition, string confirmedCase, string note, string suspectedCase, string probableCase, string communityCase, string keyMessage) {
            this.Id = id;
            this.Name = name;
