...
namespace Infrastructure.Read.MongoDb
{
    ...
    {
        public static IBsonSerializer<T> CreateInstance<T>(T instance)
        {
            return new ConceptSerializer<T>(instance);
        }
    }*/
    ...
    public class ConceptSerializer<T> : IBsonSerializer<T>
    {
        ...
        private object GetDeserializedValue(Type valueType, ref IBsonReader bsonReader)
        {
