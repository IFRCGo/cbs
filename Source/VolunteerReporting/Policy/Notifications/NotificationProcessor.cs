...
//            var dataCollector = _dataCollectors.Query.Where(a => a.PhoneNumbers.Where(x => x.Value != notification.OriginNumber));
...
//            var healthRiskId = _healthRisks.Query.Where(i => i.ReadableId == healthRiskReadableId);
