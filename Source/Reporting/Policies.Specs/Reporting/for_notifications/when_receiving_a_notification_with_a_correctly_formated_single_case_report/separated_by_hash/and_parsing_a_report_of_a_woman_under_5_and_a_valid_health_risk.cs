...
namespace Policies.Specs.Reporting.for_notifications.when_receiving_a_notification_with_a_correctly_formated_single_case_report.separated_by_hash
{
    ...
    public class and_parsing_a_report_of_a_woman_under_5_and_a_valid_health_risk : given.a_text_message_received_builder
    {
        ...
        Establish context = () =>
        {
            received_text_message = get_valid_text_message_received(is_female, age_is_under_5);
        };
