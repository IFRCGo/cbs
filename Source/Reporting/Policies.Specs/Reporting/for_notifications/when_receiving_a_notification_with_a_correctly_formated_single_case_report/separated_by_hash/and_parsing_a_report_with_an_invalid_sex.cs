...
namespace Policies.Specs.Reporting.for_notifications.when_receiving_a_notification_with_a_correctly_formated_single_case_report.separated_by_hash
{
    ...
    public class and_parsing_a_report_with_an_invalid_sex : given.a_text_message_received_builder
    {
        ...
        Establish context = () => received_text_message = get_text_message_received_with_invalid_sex(false);
