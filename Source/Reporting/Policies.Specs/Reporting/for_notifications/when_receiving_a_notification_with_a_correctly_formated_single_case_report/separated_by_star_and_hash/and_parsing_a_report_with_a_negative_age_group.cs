...
namespace Policies.Specs.Reporting.for_notifications.when_receiving_a_notification_with_a_correctly_formated_single_case_report.separated_by_star_and_hash
{
    [Subject("Notification")]
    public class and_parsing_a_report_with_a_negative_age_group : given.a_text_message_received_builder_for_single_case_report_separated_by_star_and_hash
    {
        ...
        Establish context = () => received_text_message = text_message_received_with_negative_age_group(false);
