...
namespace Policies.Specs.Reporting.for_notifications.when_receiving_a_notification_with_a_correctly_formated_single_case_report.separated_by_star_and_hash
{
    ...
    public class and_parsing_a_report_of_a_man_under_5_and_a_valid_health_risk : given.a_text_message_received_builder_for_single_case_report_separated_by_star_and_hash
    {
        ...
        It should_be_male_aged_under_5 = () => result.MalesUnder5.ShouldEqual(1);
