...
using Policies.Specs.Reporting.for_notifications.when_parsing_a_correctly_formated_aggregated_case_report_sms.separated_by_star_and_hash.given;

namespace Policies.Specs.Reporting.for_notifications.when_parsing_a_correctly_formated_aggregated_case_report_sms.separated_by_star_and_hash
{
    [Subject("Notification")]
    public class when_report_has_a_negative_number_of_cases_of_females_under_5 : text_message_received_events_containing_aggregated_case_report_separated_by_star_and_hash
    {        
        ...
        Establish context = () => received_text_message = text_message_received_with_negative_cases_of_female_under_5();
