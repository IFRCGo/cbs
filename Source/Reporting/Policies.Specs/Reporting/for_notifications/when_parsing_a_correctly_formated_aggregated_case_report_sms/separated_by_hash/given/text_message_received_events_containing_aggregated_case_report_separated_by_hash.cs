...
{
    public class text_message_received_events_containing_aggregated_case_report_separated_by_hash : text_message_received_events_containing_aggregated_case_reports
    {
