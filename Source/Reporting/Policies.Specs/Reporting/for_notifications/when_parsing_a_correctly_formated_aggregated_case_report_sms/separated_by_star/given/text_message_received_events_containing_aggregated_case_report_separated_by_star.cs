...
{
    public class text_message_received_events_containing_aggregated_case_report_separated_by_star : text_message_received_events_containing_aggregated_case_reports
    {
