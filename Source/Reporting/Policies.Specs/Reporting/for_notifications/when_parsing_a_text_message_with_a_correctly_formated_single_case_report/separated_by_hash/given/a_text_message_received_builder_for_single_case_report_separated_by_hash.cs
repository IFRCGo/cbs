...
namespace Policies.Specs.Reporting.for_notifications.when_parsing_a_text_message_with_a_correctly_formated_single_case_report.separated_by_hash.given
{
    public class a_text_message_received_builder_for_single_case_report_separated_by_hash : Policies.Specs.Reporting.for_notifications.when_parsing_a_text_message_with_a_correctly_formated_single_case_report.
        given.a_text_message_received_builder_for_single_case_report
    {
        ...
        protected static TextMessageReceived text_message_received_with_out_of_range_sex(bool under5) => text_message_received_with_out_of_range_sex(under5, separator);
    }
}