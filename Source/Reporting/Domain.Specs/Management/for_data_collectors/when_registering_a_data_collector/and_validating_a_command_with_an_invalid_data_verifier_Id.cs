...
namespace Domain.Specs.Management.for_data_collectors.when_registering_a_data_collector
{
    ...
    public class and_validating_a_command_with_an_invalid_data_verifier_Id
    {
        ...
        It should_identify_the_dataVerifier_id_as_the_problem = () => validation_results.ShouldHaveInvalidProperty(nameof(cmd.DataVerifierId));
    }
}