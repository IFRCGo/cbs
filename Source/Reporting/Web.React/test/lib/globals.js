...
module.exports = {
  before(done) {
    ...
    const parcelPromise = ChildProcess.create('npx', ['parcel', './public/index.html'], Object.assign({
      NODE_ENV: 'nightwatch',
      PORT: 9001
    }, process.env), {
    ...
    const cbsNodePromise = ChildProcess.create('npx', ['cbs-node-server'], Object.assign({
      NODE_ENV: 'nightwatch',
      PORT: 9001
    }, process.env), {
    ...
    Promise.all([parcelPromise, cbsNodePromise]).then(([parcelChildProcess, nodeChildProcess]) => {
