...
import { EditUserFormDataCollectorComponent } from './edit-user-form-data-collector/edit-user-form-data-collector.component'
...
export const USER_FORM_ROUTES: Routes = [
    ...
    {
        path: `${EDIT_USER_URL_PREFIX}/${DATA_COLLECTOR_PATH}/:id`,
        component: EditUserFormDataCollectorComponent
    }
];
