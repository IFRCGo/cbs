...
//     public class when_validating_and_assigned_national_societies_are_empty
//     {
...
//             require_assigned_national_societies.SetupGet(m => m.AssignedNationalSocieties).Returns(new Guid[0]);
//         };
