...
namespace Domain.Specs.StaffUser.Roles.RequirePhoneNumbers
{

     [Subject(typeof(IRequirePhoneNumbers))]
    public class when_validating_and_phone_numbers_are_empty
    {
        ...
        Establish context = () =>
        {
            ...
            require_phone_numbers.SetupGet(m => m.PhoneNumbers).Returns(new string[0]);
        };
